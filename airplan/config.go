...
type Settings struct {
	...
	Theme           string   `toml:"theme" json:"theme,omitempty" jsonschema_description:"Force one theme for every mode and omit theme controls; overrides light_theme, dark_theme, and available_themes."`
