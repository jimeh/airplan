...
gh release verify v0.7.0 --repo jimeh/airplan

gh attestation verify airplan_0.7.0_darwin_arm64.tar.gz \
  --repo jimeh/airplan

docker pull ghcr.io/jimeh/airplan:0.7.0
gh attestation verify oci://ghcr.io/jimeh/airplan:0.7.0 \
  --repo jimeh/airplan \
