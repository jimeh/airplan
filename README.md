...
gh release verify v0.6.0 --repo jimeh/airplan

gh attestation verify airplan_0.6.0_darwin_arm64.tar.gz \
  --repo jimeh/airplan

docker pull ghcr.io/jimeh/airplan:0.6.0
gh attestation verify oci://ghcr.io/jimeh/airplan:0.6.0 \
  --repo jimeh/airplan \
